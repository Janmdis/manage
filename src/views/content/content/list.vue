  ...
  <section  class="cms-body flex">
    ...
    <div class="cms-content-right">
      ...
      <div class="cms-list-header clearfix flex">
        ...
        <div class="cms-left marginLeft">
          <router-link to="/content/import">
            <el-button type="primary" @click='isImportAll' >
        ...
        <div  style="margin-top:16px;flex:auto">
          <div class="el-checkbox-group cms-left">
              ...
              <el-select  class="cms-left"  placeholder="所有状态" v-model="params.queryStatus" @change="query" style=" width:120px">
                        ...
                        <el-option label="审核中" value="passed"></el-option>
        ...
        <el-table-column label="操作" align="center">
          <div slot-scope="scope">
              <template v-if="scope.row.status==2">
                <cms-button  disabled type="edit" style="background-color:#c1c1c1"></cms-button>
              </template>
              <template v-else>
                <cms-button  disabled type="edit" @click.native="routerLink('/content/update','update',scope.row.id)"></cms-button>
              </template>
      ...
      <div class="content-fiexd">
          ...
          <el-button :disabled="disabled" @click="batch($api.contentCheck)" v-perms="'/content/check'">审核</el-button>
...
export default {
  ...
  methods: {
    isImportAll(){
        localStorage.removeItem('isHaveImportList')
    },
    addChannel(command) {
      //添加内容，获取栏目id 模型id
