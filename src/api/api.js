...
const api = {
  ...
  queryNewsDetail: setAdminApi("content/queryNewsDetail"), //文章导入页面修改详情查询接口
  updateChooseNews: setAdminApi("content/updateChooseNews"), //文章导入页面修改接口
  deleteChooseNews: setAdminApi("content/deleteChooseNews"), //文章导入页面删除接口
  chooseNews: "/api/admin/content/chooseNews", //Excel文章选择接口
  chooseNewsPage: setAdminApi("content/chooseNewsPage"), //文章导入页获取分页接口
