...
import cmsModelinput from './pagecomponents/cmsmodelInput.vue'//列表筛选
import cmsTable from './pagecomponents/cmstable.vue'//列表筛选
...
const cmsComponents = {
    install: function (Vue) {
        ...
        Vue.component('cmsModelinput', cmsModelinput);
