    ...
    children: [{
      ...
      children: [{
        ...
        component: resolve => { require(['@/views/content/content/list.vue'], resolve) }
          ...
          path: '/content/import',
          name: '批量导入',
          component: resolve => { require(['@/views/content/content/import.vue'],resolve)}
        },{
          path: '/content/importEdit',
          name: '批量导入修改',
          component: resolve => { require(['@/views/content/content/importEdit.vue'],resolve)}
      }]
    }, {
      path: '/topic',
      name: '专题管理', //专题管理
    ...
    children: [
      {
        ...
        isParent: true,
        name: '内容复用', //内容复用
        component: resolve => { require(['@/views/operate/contentReuse/list.vue'], resolve) },
      },
      {
      path: '/workflow',
      name: '工作流',//工作流
      ...
      children: [{
              ...
              name: '工作流列表',
              component: resolve => { require(['@/views/operate/workflow/list.vue'], resolve) },
          },{
              path: '/workflow/save',//工作流添加
              name: '工作流添加',
              component: resolve => { require(['@/views/operate/workflow/edit.vue'], resolve) },
          },{
        ...
        children: [
            {
                ...
                name: '共享列表',
                component: resolve => { require(['@/views/operate/contentShare/list.vue'], resolve) },
            },
            {
                path: '/contentShare/view',//内容查看
                name: '内容查看',
                component: resolve => { require(['@/views/operate/contentShare/edit.vue'], resolve) },
            },
        ]
      },
      {
              ...
              children: [
                {
                  path: '/active/list',
                  name: '首页活动统计列表',
                  component: resolve => { require(['@/views/operate/statistics/active.vue'], resolve) },
                },
              ]
            },
            {
              ...
              name: '退租问卷统计',
              component: childView,
              redirect: '/retire/list',
              children: [
                {
                  path: '/retire/list',
                  name: '退租问卷统计列表',
                  component: resolve => { require(['@/views/operate/statistics/retire.vue'], resolve) },
                },
              ]
            }
