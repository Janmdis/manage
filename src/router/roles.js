          ...
          children: [
            {
              ...
              children: [
                ...
                {
                  name: "批量编辑",
                  role: "/content/importEdit",
                  api: [api.updateChooseNews]
                },
                {
                  name: "修改",
                  role: "/content/update",
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  name: "添加",
                  role: "/topic/save",
                  api: [api.topicSave, api.topicTplList]
                },
                {
                  name: "删除",
                  role: "/topic/delete",
                ...
                },
                {
                  name: "修改",
                  role: "/topic/update",
                  api: [api.topicUpdate, api.topicTplList]
                },
                {
                  name: "保存排序",
                  role: "/topic/priority",
          ...
          children: [
            {
              name: "会员管理",
              role: "/user",
              api: [api.memberGet, api.groupList],
              children: [
                {
                  name: "会员列表",
                  role: "/user/list",
            ...
            },
            {
              name: "站内信管理",
              role: "/message",
              api: [api.messageList, api.memberCheckName],
              children: [
                {
                  name: "列表",
                  role: "/message/list",
        ...
        children: [
          ...
          },
          {
            ...
            api: [
              ...
              api.mysqlDataFiles,
              api.oracleDataFiles,
              api.sqlserverDataFiles,
              api.db2DataFiles,
              api.mysqDataListDataBases,
              api.sqlserverDataListDataBases,
              api.mysqlDataRevert,
              api.oracleDataRevert,
              api.sqlserverDataRevert,
              api.db2DataRevert,
              api.mysqlDataDefaultCatalog,
              api.sqlserverDataDefaultCatalog
            ]
          },
          {
            name: "备份列表",
            ...
            children: [
              ...
              },
              {
                ...
                api: [
                  api.mysqlDataDelete,
                  api.oracleDataDelete,
                  api.sqlserverDataDelete,
                  api.db2DataDelete
                ]
              },
              {
                ...
                api: [
                  api.mysqlDataExport,
                  api.oracleDataExport,
                  api.sqlserverDataExport,
                  api.db2DataExport
                ]
              },
              {
                ...
                api: [
                  api.mysqlDataRename,
                  api.oracleDataRename,
                  api.sqlserverDataRename,
                  api.db2DataRename
                ]
              }
            ]
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            api: [
              api.configCompanyGet,
              api.configCompanyUpdate,
              api.dictionaryType
            ]
          },
          {
